public class Cellule<TypeInfo> {
    ...
    // information portée par cette Celllule
    private TypeInfo info;
    // référence vers sa Cellule suivante
    private Cellule<TypeInfo> celluleSuivante;

    /**
     * Constructeur de cette Cellule sans suivante
     * @param info
     */
    ...
    /**
     * Constructeur de cette Cellule avec celluleSuivante comme suivante
     * @param info
