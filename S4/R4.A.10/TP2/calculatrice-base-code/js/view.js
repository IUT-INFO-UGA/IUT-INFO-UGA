...
export const view = {
  ...
  parenthesisOpen: document.querySelector(
    "div.ligne_boutons:nth-child(3) > input:nth-child(2)"
  ),
  parenthesisClose: document.querySelector(
    "div.ligne_boutons:nth-child(3) > input:nth-child(3)"
  ),
  division: document.querySelector(
    "div.ligne_boutons:nth-child(3) > input:nth-child(4)"
  ),
